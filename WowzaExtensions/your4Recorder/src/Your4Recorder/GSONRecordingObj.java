...
public class GSONRecordingObj implements Delayed{
    ...
    @Expose private long durationMS;
    ...
    public void removeFromFileSystem(){
        File remFile = new File(getOutputPath());
        remFile.delete();
        System.out.println("Deleted: " + remFile.getName());
    }
    ...
    public void updateRecordingStatus(){
        ...
        try {
            System.out.println("Updating Recording State");
