...
%One weakness seen in this question is that it does not differentiate whether a particular aspect positively or negatively influenced viewers - only the the strength of the influence is shown.
