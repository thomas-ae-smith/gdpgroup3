...
\subsubsection{Must Have}
	\paragraph{Functional}
		\begin{enumerate}
			...
			\item{The user should be able to skip an advert.}
...
\subsubsection{Should Have}
	...
	\paragraph{Non-functional}
		\begin{enumerate}
			\item{A user must be shown a stream within 10 seconds of requesting it.}
		\end{enumerate}
\subsubsection{Could Have}
	...
	\paragraph{Non-functional}
		\begin{enumerate}
			\item{The service should gracefully degrade given an insufficient Internet connection speed to use lower definition}
		\end{enumerate}
\subsubsection{Wont Have}
\paragraph{Functional}
		\begin{enumerate}
			\item{The system should allow buffering of the live stream for later 1-time off-line playback.}
		\end{enumerate}
\paragraph{Non-functional}
		\begin{enumerate}
			\item{The user should not need an active Internet connection}
			\item{The system architecture should allow node loss with no service degradation}
		\end{enumerate}
