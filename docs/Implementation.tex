...
In order to ensure the completion of the project in the limited time available the requirements were subdivided using the MoSCoW system developed as part of \citet{clegg1994case}.
