...
%Current Internet TV streaming services - such as BBC iPlayer\footnote{BBC iPlayer --\footurl{http://www.bbc.co.uk/iplayer/}} and 4oD\footnote{4oD -- \footurl{http://www.channel4.com/programmes/4od}} - allow users to watch either Live TV or programmes that have been shown previously. This can be done via a web-interface on a computer. iPlayer and 4oD both have apps available for other platforms, such as the Sony PS3 and Android smart phones\footnote{Video On Demand Apps -- \footurl{http://apps.channel4.com/view-all-apps/}, \footurl{https://play.google.com/store/apps/details?id=bbc.iplayer.android}}.
