...
\begin{enumerate}
\item Atlas API\footnote{Atlas API -- \footurl{http://atlasapi.org}} -- a REST service for accessing Electronic Programme Guide records and other programme data. Thanks to MetaBroadcast\footnote{MetaBroadcast website -- \footurl{http://metabroadcast.com}}, in particular Jonathan Tweed, who have provided us with access to this. This data is in turn provided by the Press Association\footnote{Press Association website -- \footurl{http://www.pressassociation.com}}.
\item MovieLens\footnote{MovieLens -- \footurl{http://movielens.umn.edu}} -- rating and demographic data, which was used for initial training for the recommendation system. Thanks to GroupLens research.
