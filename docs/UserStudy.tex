...
\section{User Study}
	...
	\end{figure}
	Little difference in time perception is by Figure~\ref{fig:time_perception}, which is confirmed when a Student's independent two-sample t-test performed on the time estimate data gives 0.
	...
	\begin{figure}[h!]
		...
		\caption{Average percentage of advertisements recalled depending on the round the advert was seen in (interactive round, noninteractive round or both rounds).}
		\label{fig:recall}
	\end{figure}
