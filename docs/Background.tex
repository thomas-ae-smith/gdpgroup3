...
\subsection{Interactive television}
	...
	Television is already switching to become an interactive platform; the 2012 live election debate was augmented with live news and live twitter streams, discussed by \citet{2010_election}, and the 2012 Olympic Games was given an online interactive video player\footnote{Interactive 2012 Onlympics video player -- \footurl{http://www.bbc.co.uk/sport/olympics/2012/live-video}}. \citet{tv_stb_overview} gives an overview of the state of interactive TV set-top box development, and describes a rapidly growing market in Europe and Asia. A number of problems in standardization, network architecture and upgradability are described, but many of these become redundant upon removal of the assumption that interactive TV requires a set-top box, and instead assuming the software runs on a personal computer communicating via the internet.
