...
\subsection{Targeted adverts}
	...
	By offering highly targeted ads, two parties benefit: the advertiser and the end-user. \citet{t} describes how accurately targeted advertisements have greater value, which is clearly beneficial to the advertiser, but also for the user; higher value adverts means fewer need to be shown to cover the programming costs. In addition, % RELEVANCE
